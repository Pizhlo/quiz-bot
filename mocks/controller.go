...
func (m *MockteleCtx) Boost() *telebot.BoostUpdated {
	m.ctrl.T.Helper()
...
func (mr *MockteleCtxMockRecorder) Boost() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Boost", reflect.TypeOf((*MockteleCtx)(nil).Boost))
}

// BoostRemoved mocks base method.
func (m *MockteleCtx) BoostRemoved() *telebot.BoostRemoved {
	m.ctrl.T.Helper()
...
func (mr *MockteleCtxMockRecorder) BoostRemoved() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BoostRemoved", reflect.TypeOf((*MockteleCtx)(nil).BoostRemoved))
}
...
func (m *MockteleCtx) RespondAlert(text string) error {
	m.ctrl.T.Helper()
...
func (mr *MockteleCtxMockRecorder) RespondAlert(text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RespondAlert", reflect.TypeOf((*MockteleCtx)(nil).RespondAlert), text)
}

// RespondText mocks base method.
func (m *MockteleCtx) RespondText(text string) error {
	m.ctrl.T.Helper()
...
func (mr *MockteleCtxMockRecorder) RespondText(text interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RespondText", reflect.TypeOf((*MockteleCtx)(nil).RespondText), text)
}
...
func (m *MockteleCtx) Topic() *telebot.Topic {
	m.ctrl.T.Helper()
...
func (mr *MockteleCtxMockRecorder) Topic() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Topic", reflect.TypeOf((*MockteleCtx)(nil).Topic))
}
